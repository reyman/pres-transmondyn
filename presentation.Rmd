...
SLocal, 3 années de développements, 4 mécanismes, 3 critères d'évaluation,  des millions d'executions pour calibrer, une réplication de netlogo vers scala, et toujours des bugs (voir article @Schmitt2014)
...
<!--- OSullivan, Rouchier 2013, Squazoni2010, etc. --->
